...
const Cart = () => {
  const { cartItems, handleQuantity, deleteCartItem, order, selectedAddress } =
              ...
              <Box sx={{ display: "flex", flexDirection: "column", flex: 1 }}>
                ...
                <Box sx={{ display: "flex", alignItems: "center", padding: 1 }}>
                  <Button
                    ...
                    onClick={() => handleConfirm(medicine.drugCode)}
                  >
                    Delete
                  </Button>
                  ...
                  <IconButton
                    onClick={() =>
                      handleQuantity(medicine.drugCode, "Increase")
                    }
                    sx={{ marginLeft: 4 }}
                  >
                  ...
                  <IconButton
                    onClick={() =>
                      handleQuantity(medicine.drugCode, "Decrease")
                    }
                  >
